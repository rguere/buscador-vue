    ...
    <div class="panel-body">
      <div v-if="hayCuentasDisponibles">
        ...
        <div class="flex-space-between-flex-end">
          ...
          <div v-if="selected_cuentas_disponibles.length !== 0">
...
export default {
  ...
  methods: {
    ...
    showModal() {
      sendPageView(
        `filtro-anios-con-cuentas-disponibles`,
        `Buscador - Filtro de Años con cuentas disponibles`
      );
      this.modalVisible = true;
    },
    hideModal() {
      ...
      if (
        ...
        this.$store
          ...
          .then((response) => {
            ...
            this.selected_cuentas_disponibles_string = JSON.stringify(
              this.selected_cuentas_disponibles
            );
    ...
    takeIntoAccountDefault() {
      if (
        this.selected_cuentas_disponibles &&
        this.selected_cuentas_disponibles.length > 1 &&
