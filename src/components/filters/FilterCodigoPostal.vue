...
export default {
  ...
  methods: {
      ...
      if (this.selected_zip_codes && this.selected_zip_codes.length !== 0) {
        ...
        this.$store
          ...
          .then((response) => {
            ...
            this.dataFrm = "";
            this.selected_zip_codes_string = JSON.stringify(
              this.selected_zip_codes
            );
            this.zip_codes = { validos: [], invalidos: [] };
    ...
    editSearch() {
      this.search_edit = true;
      setTimeout(() => {
        document.getElementById("zip_codes").focus();
      }, 100);
    },
    ...
    validateRankSearchZipCodes() {
      ...
      if (!this.$v.$invalid) {
        ...
        let zero_on_left =
          this.from_zip_code.charAt(0) === "0" ||
          this.to_zip_code.charAt(0) === "0"
            ? true
            : false;
