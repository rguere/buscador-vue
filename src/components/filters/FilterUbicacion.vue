  ...
  <div class="panel panel-default cd" id="filter_ubicacion">
    ...
    <div class="panel-body">
      <div v-if="!loading && search.provincia_localidad && search.provincia_localidad.length != 0">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="bv-modal-filter-ubicacion">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showModal () {
        $('#bv-modal-filter-ubicacion').modal({ backdrop: 'static', show: true })
      },
      hideModal () {
        $('#bv-modal-filter-ubicacion').modal('hide')
      },
      /**
