  ...
  <div class="panel panel-default cd" id="filter_numero_de_empleados">
    <div class="panel-heading">
      <p class="panel-title roboto white">
        ...
        >({{ selected_by_empleados | numeral('0,0') }} empresas seleccionadas)</span>
      </p>
    </div>
    <div class="panel-body">
          ...
          <div>
            <div class="checkboxs-resaldado float-right" v-if="itemIncluirNull">
              <label class="custon-checkboxs">
                ...
                <span
                  class="title"
                >Incluir aquellas empresas en las que se desconoce su número de empleados</span>
              </label>
            </div>
          </div>
        </div>
                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div
                          class="form-group"
                          :class="{ 'has-error has-feedback': $v.employees_from.$error }"
                        >
                      ...
                      <div class="col-md-4">
                        <div
                          class="form-group"
                          :class="{ 'has-error has-feedback': $v.employees_to.$error }"
                        >
                      ...
                      <div class="col-md-4">
                        ...
                        >
                          BUSCAR
                          <i :class="(loadingEmpleados)?'fa  fa-spinner fa-spin':'fa  fa-search'"></i>
                        </button>
                      </div>
                      <div class="col-md-12">
      ...
      <div
        v-if="search.empleados && search.empleados.length === 0 && !loading"
...
export default {
  ...
  methods: {
    ...
    showModal() {
      this.$v.$reset();
      sendPageView(
        `filtro-numero-de-empleados`,
        `Buscador - Filtro de Número de empleados`
      );
      this.modalVisible = true;
    },
    hideModal() {
